...
import {
  ...
  type ItemType,
  repayItemChangeKey,
} from '@/pages/bigScreen/utils/others'
...
.bottom_menu {
  ...
  .n-button {
    ...
    pointer-events: auto;
    background: url('@/pages/bigScreen/assets/img/bottom_btn.png') no-repeat;
    background-size: 100%;
    ...
    &:hover,
    &.is_active {
      background: url('@/pages/bigScreen/assets/img/bottom_btn_hover.png') no-repeat;
      background-size: 100%;
    }
  }
}
