 ...
 * @LastEditTime : 2024-11-03 00:53:50
 * @Description  :
-->
...
const option: ComposeOption<BarSeriesOption | EffectScatterSeriesOption | GridComponentOption | PictorialBarSeriesOption> = {
  grid: {
    bottom: 0,
    containLabel: true,
    left: 0,
